...
def main():
    ...
    m = mapnik.Map(800, 600, "+init=epsg:3857")
    ...
    provpoly_lyr.srs = "+init=epsg:3978"
    provpoly_lyr.datasource = mapnik.Shapefile(
        file=path.join(root, "../data/boundaries"), encoding="latin1"
    )
