...
if mapnik.has_grid_renderer():
    ...
    def show_grids(name, g1, g2):
        ...
        if g1["grid"] != g2["grid"]:
            ...
            val += " ✓ grid matches\n"
        if list(g1["data"].keys()) != list(g2["data"].keys()):
    ...
    grid_feat_id3 = {
        "data": {
            "1": {"Name": "South East", "__id__": 1},
            "2": {"Name": "South West", "__id__": 2},
            "3": {"Name": "North West", "__id__": 3},
            "4": {"Name": "North East", "__id__": 4},
        },
        "grid": [
            "                                                                ",
            "                                                                ",
