...
geojson = {
    ...
    "geometry": {
        ...
        "coordinates": [
            [
                [-17963313.143242701888084, -6300857.11560364998877],
                [-17963313.143242701888084, 13071343.332991421222687],
                [7396658.353099936619401, 13071343.332991421222687],
                [7396658.353099936619401, -6300857.11560364998877],
                [-17963313.143242701888084, -6300857.11560364998877],
            ]
        ],
    },
...
def test_that_coordinates_do_not_overflow_and_polygon_is_rendered_memory():
    ...
    # 17/20864/45265.png
    m.zoom_to_box(
        mapnik.Box2d(-13658379.710221574, 6197514.253362091, -13657768.213995293, 6198125.749588372)
    )
